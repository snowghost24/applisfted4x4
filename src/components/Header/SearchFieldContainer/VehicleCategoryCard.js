...
function CategoryCard(props) {
  const { classes, theme, categoryInfo, vehicle } = props;
 console.log('in vehicle catergory',categoryInfo)
  let createdLink = `/browsevehicle/${vehicle}/${categoryInfo.catagory_tree}`
  // let createdLink = 'nothing'
  return (
